...
The proposed [spacecraft startup and antenna deployment sequence](docs/architecture/startup_sequence.md)
includes a reusable Mermaid diagram, board responsibilities, and remaining flight-policy decisions.
