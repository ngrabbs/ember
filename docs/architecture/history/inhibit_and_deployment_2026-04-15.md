# Historical inhibit and deployment discussion

**Historical reference, archived September 21, 2026.** The original discussion
below mixes prototype decisions, alternatives, and unverified flight assumptions.
It is retained for traceability, not as a flight requirement or wiring authority.
See the [current decision summary](../inhibit_and_deployment.md) and
[operations draft](../operations/README.md) before using it.
