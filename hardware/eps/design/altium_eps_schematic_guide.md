...
stack (IHU, comms, payload) use the stackthrough variant
ESQ-126-39-G-D.
...
pp. 13–16). All boards in the stack use the same H1/H2 pin
...
| Pin | Pumpkin name | Net | Direction (EPS) | Function |
|---|---|---|---|---|
